...
public sealed class ServerEntryPoint : IServerEntryPoint, IDisposable
{
    ...
    private void OnItemChanged(object? sender, ItemChangeEventArgs e)
    {
        try
        {
            ...
            {
                _logger.Info(
                    "Skipped item {0}. OfficialRating={1}, Reason={2}, Preset={3}, TargetLibraryCount={4}.",
                    e.Item.Name,
            ...
            _logger.Info(
                "Standardized OfficialRating for {0} from {1} to {2}. Lock added: {3}, original tag added: {4}, history saved: {5}",
                e.Item.Name,
