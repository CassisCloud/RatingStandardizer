...
2. Add the custom package source or repository URL supported by your Emby build and paste `https://raw.githubusercontent.com/CassisCloud/RatingStandardizer/main/manifest.emby.json`.
